...
class CentralCorridor(Scene):
	...
	def enter(self):
		print(dedent("""
					The Gothons of Planet Percal #25 have inveded your ship and destroyed your entire crew. You are the last surviving member and your last mission is to get the neutron destruct bomb from the Weapons Armory, put it in the bridge, and blow the ship up after getting into an escape pod.
					
					You're running down the central corridor to the Weapons Armory when a Gothon jumps, red scaly skin, dark grimpy teeth, and evil clown costume flowing around his hate filled body. He's blocking the door to the Armory and about to pull a weapon to blast you.
		"""))
...
class LaserWeaponArmory(Scene):
	...
	def enter(self):
		print(dedent("""
				...
				"""))
		code = f"{randin(1,9)}{randint(1,9)}{randint(1,9)}"
		guess = input("[keypad]> ")
		guesses = 0
...
class TheBridge(Scene):
	...
	def enter(self):
		...
		if action == "throw the bomb":
			...
			print(dedent("""
						You point your blaster at the bomb under your arm and the Gothons put their hands up and start to sweat. You inch backwards to the door, open it, and then carefully place the bomb on the floor, pointing your blaster at it.  You then jump back through the door, punch the close button and blast the lock so the Gothon's can't get out.  Now that the bomb is placed you run to the escape pod to get off this tin can.
						"""))
